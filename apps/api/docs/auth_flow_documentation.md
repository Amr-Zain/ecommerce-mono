# Ecommerce Auth Module & Passwordless Flow Documentation

This document describes the modern passwordless authentication architecture, guest session handling, and admin-only secure credential flows implemented in the Ecommerce API.
...
To allow clients to browse, add reviews, configure shipping addresses, and create orders before signing in, Ecommerce supports transient **Guest Users**:
