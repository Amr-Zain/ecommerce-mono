...
import { AdminOrderFilter, AdminOrderRecord, IOrdersRepository, ORDERS_REPOSITORY } from '@/common/interfaces';
...
export class AdminOrdersRepository {
  ...
  async findAll(query: AdminOrderQueryDto, langId: string = 'en') {
    ...
    } satisfies PaginatedResult<ReturnType<AdminOrdersRepository['formatOrder']>>;
  }
  ...
  private formatOrder(order: AdminOrderRecord) {
