                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <CardDescription className="mt-1 flex flex-wrap gap-x-4 gap-y-1">
                            <span>{t('table.columns.code')} #{user.id}</span>
                            <span>•</span>
                            <span>{t('table.createdAt')} {formatDate(user.created_at)}</span>
                            {user.last_login_at && (
                                <>
                                    <span>•</span>
                                    <span>{t('userShow.last_login')} {formatDate(user.last_login_at)}</span>
                                </>
                            )}
                        </CardDescription>
                    </div>
