...
export class DateUtil {
   ...
   */
  static formatWithLocale(date: Date, locale = 'en-US', options?: Intl.DateTimeFormatOptions): string {
   ...
   */
  static formatByLang(date: Date, lang: 'en' | 'ar', style: 'short' | 'long' = 'short'): string {
    if (lang === 'ar') {
